...
void setup()
{
  ...
  sensor.oled(ETH.macAddress(mac)); // start screen - starts with MAC address showing
  ...
  sensor.oled(ETH.localIP()); // update screen - should show IP address
